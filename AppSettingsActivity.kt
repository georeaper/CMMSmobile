    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                var dbName by remember { mutableStateOf(sharedPreferences.getString("dbName", if (useRemoteDB) "RemoteDB240812a" else "LocalDB240901") ?: "") }
                ...
                Switch(
                    ...
                    onCheckedChange = {
                        useRemoteDB = it
                        dbName = if (it) "RemoteDB240812a" else "LocalDB240901"
