package com.gkprojects.cmmsandroidapp.Fragments.HomeDashboard
...
class HomeDashboardAdapter(private val context: Context, private var list:ArrayList<HomeRecyclerViewData>): RecyclerView.Adapter<HomeDashboardAdapter.MyViewholder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup,viewType: Int ): HomeDashboardAdapter.MyViewholder {
        val itemView=
            LayoutInflater.from(parent.context).inflate(R.layout.child_recyclerview_overview_home,parent,false)
        return HomeDashboardAdapter.MyViewholder(itemView)
    }
    ...
    override fun onBindViewHolder(holder: HomeDashboardAdapter.MyViewholder, position: Int) {
